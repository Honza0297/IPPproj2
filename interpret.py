...
verbose = True  # TODO !!!only for debug
...
class Interpreter:
    ...
    def interpret_instruction(self, instruction):
        ...
        jump = [False, None]
        instruction_done = self.switch_interpreting(instruction, jump)
        if verbose:
    ...
    def switch_interpreting(self, instruction, jump):
        ...
        if opcode == "DEFVAR":
            ...
            return self.read(self.get_arg(instruction, 1), self.get_arg(instruction, 2))
        elif opcode == "STRLEN":
